...
static void rv64_nuclei_nx_cpu_init(Object *obj)
{
    CPURISCVState *env = &RISCV_CPU(obj)->env;
    set_misa(env, RV64 | RVI | RVM | RVA | RVC | RVU);
    set_priv_version(env, PRIV_VERSION_1_10_0);
...
static void rv64_nuclei_ux_cpu_init(Object *obj)
{
    CPURISCVState *env = &RISCV_CPU(obj)->env;
    set_misa(env, RV64 | RVI | RVM | RVA | RVC | RVS | RVU);
    set_priv_version(env, PRIV_VERSION_1_10_0);
...
static const TypeInfo riscv_cpu_type_infos[] = {
    ...
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_NX600,       rv64_nuclei_nx_cpu_init),
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_UX600,       rv64_nuclei_ux_cpu_init),
#endif
};
